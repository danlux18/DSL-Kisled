...
public class KisledConditionImpl extends ASTWrapperPsiElement implements KisledCondition {

  public KisledConditionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KisledSignal getSignal() {
    return findNotNullChildByClass(KisledSignal.class);
  }
