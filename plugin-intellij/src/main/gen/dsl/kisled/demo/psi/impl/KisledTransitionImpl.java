...
public class KisledTransitionImpl extends ASTWrapperPsiElement implements KisledTransition {

  public KisledTransitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KisledConditions getConditions() {
    return findNotNullChildByClass(KisledConditions.class);
  }
