...
public class KisledActionImpl extends ASTWrapperPsiElement implements KisledAction {

  public KisledActionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KisledActSignal getActSignal() {
    return findNotNullChildByClass(KisledActSignal.class);
  }
